...
/**
 * hdb 发送短信接口 2013-5-13 上午9:26:23
 */
public class Sms {
	...
	public static void main(String[] args) {
		System.out.println(sendMsg1("18123978207", "感谢您注册移小宝，您的短信验证码是：233212。【PAY】"));
		// HttpClientUtil.postHTTP("http://service.winic.org/sys_port/gateway/?","wangdj20010","wangdj20010","18600002270","晚上请你吃饭","");
